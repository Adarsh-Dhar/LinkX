...
import "../interfaces/IVVSFactory.sol"; // Ensure this import exists for the pair hash or getPair
...
library VVSLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal view returns (address pair) {
        // Safer method for testing: Ask the factory directly
        // This avoids "Init Code Hash" mismatches which are common in Foundry testnets
        pair = IVVSFactory(factory).getPair(tokenA, tokenB);
        require(pair != address(0), "VVSLibrary: PAIR_NOT_CREATED");
    }
